...
def test_create_account_with_old_account(create_account, create_new_account, start_end, set_allure):
...
@pytest.mark.smoke
def test_create_account_with_empty_all_fields(create_account, start_end, set_allure):
